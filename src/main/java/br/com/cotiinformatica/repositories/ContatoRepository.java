...
public class ContatoRepository {
	...
	public void create(Contato contato) throws Exception	{
		...
		PreparedStatement statement = connection.prepareStatement("insert into contato(nome, telefone, email, datanascimento, tipo, idusuario) values (?, ?, ?, ?, ?, ?)");
...
//------------------------------------------------------------------------------------------------------------------------------------
	...
	//método para atualizar um contato no bando de dados
	
	public void update(Contato contato) throws Exception	{
		
		Connection connection	= ConnectionFactory.createConnection();
		
		PreparedStatement statement = connection.prepareStatement("update contato set nome=?, telefone=?, email=?, datanascimento=?, tipo=? where idcontato=?");
...
//------------------------------------------------------------------------------------------------------------------------------------	
	...
	//método para deletar um contato no bando de dados
...
//-----------------------------------------------------------------------------------------------------------------------------------	
	...
	//método para consultar os contatos de 1 usuario
	...
	public List<Contato> findByUsuario(Integer idUsuario) throws Exception {
		...
		while (resultSet.next())	{
			...
			contato.setDataNascimento(new SimpleDateFormat("yyy-MM-dd").parse(resultSet.getString("datanascimento")));
...
//----------------------------------------------------------------------------------------------------------------------------------------
	...
	//método para consultar um contato através do id do contato e do id do usuario
	
	public Contato findById(Integer idContato, Integer idUsuario ) throws Exception {
		
		Connection connection = ConnectionFactory.createConnection();
		
		PreparedStatement statement = connection.prepareStatement("select * from contato where idcontato=? and idusuario=?");
